...
- [Single Agent Specification](#single-agent-specification)
  ...
  - [Per agent llm_config](#per-agent-llm_config)
  - [class](#class)
  - [toolbox](#toolbox)
  - [args](#args)
  - [allow](#allow)
  ...
  - [Per agent error_formatter](#per-agent-error_formatter)
  - [Per agent error_fragments](#per-agent-error_fragments)
...
Example: [http://localhost:8080/math_guy](http://localhost:8080/math_guy)

This enables entire ecosystems of agent webs.

### Per agent llm_config
...
The same dictionary/list specification described in [to_downstream](#to_downstream) sly_data also applies here.
