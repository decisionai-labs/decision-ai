    ...
    return (
        <section ref={sectionRef} className="py-24 px-6 relative overflow-hidden bg-[#1A1A1A]">
            ...
            <div className="absolute inset-0 opacity-20">
                <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#14B8A6]/20 rounded-full blur-3xl" />
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#EF4444]/10 rounded-full blur-3xl" />
            </div>
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                {/* Comparison table */}
                <div className={`bg-[#1F2937] rounded-2xl border border-[#374151] overflow-hidden transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    {/* Header row */}
                    <div className="grid grid-cols-3 border-b border-[#374151]">
                        <div className="p-4 sm:p-6 text-sm font-medium text-[#9CA3AF]">Feature</div>
                        <div className="p-4 sm:p-6 text-center bg-[#14B8A6]/5 border-x border-[#374151]">
                            <div className="inline-flex items-center gap-2">
                                ...
                                <span className="font-semibold text-white">NeuroSan</span>
                            </div>
                        </div>
                        <div className="p-4 sm:p-6 text-center">
                            <span className="font-semibold text-[#9CA3AF]">Traditional AI</span>
                        </div>
                    </div>
                    ...
                    {comparisonData.map((row, index) => (
                        <div
                            key={row.feature}
                            className={`grid grid-cols-3 border-b border-[#374151] last:border-b-0 transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                            style={{ transitionDelay: `${300 + index * 75}ms` }}
                        >
                            <div className="p-4 sm:p-6 text-sm text-[#E5E7EB]">{row.feature}</div>
                            <div className="p-4 sm:p-6 flex items-center justify-center bg-[#14B8A6]/5 border-x border-[#374151]">
