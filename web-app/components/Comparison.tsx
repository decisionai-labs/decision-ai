...
export function Comparison() {
    ...
    return (
        <section ref={sectionRef} className="py-24 px-6 relative overflow-hidden bg-black border-t border-white/10">
            {/* Background elements */}
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className={`text-center mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <h2 className="text-3xl sm:text-4xl font-semibold text-white mb-4">
                        Why Choose <span className="text-gradient">Decision AI?</span>
                    </h2>
                ...
                {/* Comparison table */}
                <div className={`bg-[#111111] rounded-2xl border border-white/10 overflow-hidden shadow-sm transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    {/* Header row */}
                    <div className="grid grid-cols-3 border-b border-white/10">
                        <div className="p-4 sm:p-6 text-sm font-medium text-zinc-400">Feature</div>
                        <div className="p-4 sm:p-6 text-center bg-[#14B8A6]/5 border-x border-white/10">
                            <div className="inline-flex items-center gap-2">
                                ...
                                <span className="font-semibold text-white">Decision AI</span>
                            </div>
                        </div>
                        <div className="p-4 sm:p-6 text-center">
                            <span className="font-semibold text-zinc-400">Traditional AI</span>
                        </div>
                    </div>
                    ...
                    {comparisonData.map((row, index) => (
                        <div
                            key={row.feature}
                            className={`grid grid-cols-[1fr_auto_auto] sm:grid-cols-3 border-b border-white/10 last:border-b-0 transition-all duration-500 hover:bg-white/5 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                            style={{ transitionDelay: `${300 + index * 75}ms` }}
                        >
                            <div className="p-4 sm:p-6 text-sm text-white font-medium">{row.feature}</div>
                            <div className="p-4 sm:p-6 flex items-center justify-center bg-[#14B8A6]/5 border-x border-white/10">
