...
export function SecurityShowcase() {
    ...
    return (
        <section ref={sectionRef} className="py-24 px-6 relative overflow-hidden bg-[#1A1A1A]">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                >
                                    <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#14B8A6]/20 flex items-center justify-center">
                    ...
                    <div className={`relative transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
                        <div className="relative p-8 bg-gradient-to-br from-[#1F2937] to-[#111827] rounded-3xl border border-[#374151]">
                            ...
                            <div className="relative z-10 flex flex-col gap-16">
                                ...
                                <div className="flex justify-between items-start">
                                    <div className="text-center">
                                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#14B8A6] to-[#0D9488] flex items-center justify-center mb-3 shadow-lg shadow-[#14B8A6]/30">
                                            <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                                            </svg>
                                        </div>
                                        <p className="text-xs text-[#9CA3AF]">Your Wallet</p>
                                    </div>
                                    <div className="text-center">
                                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#8B5CF6] to-[#7C3AED] flex items-center justify-center mb-3 shadow-lg shadow-[#8B5CF6]/30 animate-float-slow">
                                            <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                            </svg>
                                        </div>
                                        <p className="text-xs text-[#9CA3AF]">AI Agent</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-center">
                                    <div className="text-center">
                                        <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-[#1F2937] to-[#374151] border-2 border-[#14B8A6]/50 flex items-center justify-center mb-3 glow-pulse-teal">
                                            <div className="text-center">
                                ...
                                <div className="flex justify-between items-end">
                                    <div className="text-center">
                                        <div className="w-16 h-16 rounded-2xl bg-[#374151] flex items-center justify-center mb-3 border border-[#4B5563]">
                                            <svg className="w-8 h-8 text-[#9CA3AF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                                            </svg>
                                        </div>
                                        <p className="text-xs text-[#9CA3AF]">Tools</p>
                                    </div>
                                    <div className="text-center">
                                        <div className="w-16 h-16 rounded-2xl bg-[#374151] flex items-center justify-center mb-3 border border-[#4B5563]">
                                            <svg className="w-8 h-8 text-[#9CA3AF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <p className="text-xs text-[#9CA3AF]">Solana RPC</p>
                                    </div>
                                </div>
                            </div>
                        </div>
