        ...
        <header className="fixed top-0 left-0 right-0 z-50 glass-dark border-b border-white/10">
            <nav className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-2.5 group">
                    ...
                    <span className="font-semibold text-white group-hover:text-[#14B8A6] transition-colors">
                        Decision AI
                    </span>
                </Link>
                ...
                <div className="hidden md:flex items-center gap-8">
                    {[
                        ...
                        <Link
                            ...
                            className="relative text-sm text-zinc-400 hover:text-white transition-colors group py-1"
                        >
                            {link.label}
            ...
            <div className={`md:hidden overflow-hidden transition-all duration-300 ${mobileMenuOpen ? 'max-h-80' : 'max-h-0'}`}>
                <div className="px-6 py-4 border-t border-white/10 bg-black/80 backdrop-blur-lg">
